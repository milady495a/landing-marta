<?php
  ...
  $portfolios = [
    [
      'id' => 'portfolioModal1',
      'title' => 'Trescientos años',
      'class' => 'asesoria correccion literatura',
      'img_href' => '300a_450.jpg',
      'img_alt' => 'asesoría literaria y corrección',
      'modal_title' => 'Trescientos años',
      'modal_subtitle' => 'Asesoría literaria / Corrección',
      'modal_text' => '<p><i>Trescientos años</i> es una novela de fantasía para adultos jóvenes en la que dos adolescentes viajan al pasado y se relacionan (con más o menos acierto) con la aristocracia inglesa del siglo dieciocho. Conocen a personajes singulares y viven aventuras trepidantes que ponen en juego su amistad y su forma de ver el mundo, todavía infantil. Es una novela de aventuras, pero especialmente de madurez.</p>
      ...
      'modal_imgs' => [
        [
          'src' => '300a_informe_3.jpg',
          'alt' => 'corrección de estilo literaria ejemplo',
        ],[
          'src' => '300a_informe_2.jpg',
          'alt' => 'corrección de estilo literaria ejemplo',
        ],[
          'src' => '300a_informe_1.jpg',
          'alt' => 'corrección de estilo literaria ejemplo',
        ],[
          'src' => '300a_corr_estilo.jpg',
          'alt' => 'corrección de estilo literaria ejemplo',
        ]
      ],
      ...
      'id' => 'portfolioModal3',
      'title' => 'Centro Maná',
      'class' => 'copywriting web marketing',
      'img_href' => 'centromana.jpg',
      'img_alt' => 'copywriting marketing',
      'modal_title' => 'Centro Maná',
      'modal_subtitle' => 'Copywriting / Marketing',
      'modal_text' => '<p>El Centro Maná es un centro de psicología integrativa en Jalón, Alicante, donde puedes acudir a sesiones de terapia y a talleres de un día o residenciales.</p>
      ...
      'modal_imgs' => [
        [
          'src' => 'cm_web_8.jpg',
          'alt' => 'Copywriting terapias naturales psicología',
        ],[
          'src' => 'cm_blog_3.jpg',
          'alt' => 'Copywriting terapias naturales psicología',
        ],[
          'src' => 'cm_web_5.jpg',
          'alt' => 'copywriting diseño web terapias naturales psicología',
        ],[
          'src' => 'cm_blog_2.jpg',
          'alt' => 'Copywriting terapias naturales psicología',
        ],[
      ...
      'modal_imgs' => [
        [
          'src' => 'aez_informe_1.jpg',
          'alt' => 'corrección de estilo literaria ejemplo',
        ],[
          'src' => 'aez_informe_2.jpg',
          'alt' => 'corrección de estilo literaria ejemplo',
        ],[
          'src' => 'aez_corr_estilo.jpg',
          'alt' => 'corrección de estilo literaria ejemplo',
        ],
      ],
      'modal_footer' => '<li>Fecha: Mayo 2016</li>
      <li>Cliente: Daniela Sornís</li>
      <li>Categoría: Asesoría literaria / Corrección</li>',
    ],[
      'id' => 'portfolioModal8',
      'title' => 'Oxford DNB',
      'class' => 'correccion academico',
      'img_href' => 'oxfdnb_450_t.jpg',
      'img_alt' => 'corrección ortotipográfica',
      'modal_title' => 'Oxford dictionary of national biography',
      'modal_subtitle' => '<i>Proofreading</i> - corrección ortotipográfica',
      'modal_text' => '<p>El diccionario de biografía nacional (británica) de Oxford está siendo constantemente actualizado y cada día recibe nuevas entradas. <b>Cada entrada pasa por varias revisiones de manos de distintas personas</b>: el autor, el editor, los correctores, etc. </p>
      ...
      'modal_imgs' => [
        [
          'src' => 'oxforddnb_4.jpg',
          'alt' => 'corrección ortotipográfica proofreading oxford',
        ],[
          'src' => 'oxforddnb_3.jpg',
          'alt' => 'corrección ortotipográfica proofreading oxford',
        ],[
      ...
      'modal_footer' => '<li>Fecha: Septiembre 2015</li>
      <li>Cliente: Oxford University Press</li>
      <li>Categoría: <i>Proofreading</i> - corrección ortotipográfica</li>',
    ],[
      'id' => 'portfolioModal5',
      'title' => 'Race and Racism in Morrison',
      'class' => 'academico correccion',
      'img_href' => 'racism_450_t.jpg',
      'img_alt' => 'corrección ortotipográfica',
      'modal_title' => 'Race and racism in Toni Morrison',
      'modal_subtitle' => '<i>Proofreading</i> - corrección ortotipográfica',
      'modal_text' => '<p><i>Race and racism in Toni Morrison</i> es una tesis doctoral, un documento que recoge años de trabajo, y por eso mi clienta había contactado conmigo para asegurarse de que estaba en el mejor estado posible antes de enviarlo a sus directores de tesis y publicarlo.</p>
      ...
      'modal_imgs' => [
        [
          'src' => 'pr_tesis_4.jpg',
          'alt' => 'corrección ortotipográfica tesis universitaria',
        ],[
          'src' => 'pr_tesis_4.jpg',
          'alt' => 'corrección ortotipográfica tesis universitaria',
        ],[
      ...
      'modal_footer' => '<li>Fecha: Julio 2014</li>
      <li>Cliente: Sevim Dilara</li>
      <li>Categoría: <i>Proofreading</i> - corrección ortotipográfica</li>',
    ],[
      'id' => 'portfolioModal7',
      'title' => 'Instituto Valenciano de Terapias Naturales',
      'class' => 'correccion web',
      'img_href' => 'ivtn_450_t.jpg',
      'img_alt' => 'asesoría web corrección',
      'modal_title' => 'Instituto Valenciano de Terapias Naturales',
      'modal_subtitle' => 'Corrección ortotipográfica / Asesoría web',
      'modal_text' => '<p>El Instituto Valenciano de Terapias Naturales contaba con una página web desde hacía años, pero sabía que no le estaba sacando el máximo provecho. Por otro lado, aunque publicaba semanalmente, su equipo de redactores trabajaba sin una guía de estilo ni una estrategia de contenidos definida que les ayudara a orientar las publicaciones a una venta concreta. </p>
      ...
      'modal_imgs' => [
        [
          'src' => 'ivtn_3.jpg',
          'alt' => 'Corrección ortotipográfica asesoría web terapias naturales',
        ],[
          'src' => 'ivtn_1.jpg',
          'alt' => 'Corrección ortotipográfica asesoría web terapias naturales',
        ],[
      ...
      'modal_imgs' => [
        [
          'src' => 'byn_informe_3.jpg',
          'alt' => 'asesoría literaria informe de lectura',
        ],[
          'src' => 'byn_informe_4.jpg',
          'alt' => 'asesoría literaria informe de lectura',
        ],[
          'src' => 'byn_informe_2.jpg',
          'alt' => 'asesoría literaria informe de lectura',
        ],[
          'src' => 'byn_informe_1.jpg',
          'alt' => 'asesoría literaria informe de lectura',
        ],
      ],
      'modal_footer' => '<li>Fecha: Marzo 2018</li>
      <li>Cliente: Diana Soledad</li>
      <li>Categoría: Asesoría literaria</li>',
    ],[
      'id' => 'portfolioModal4',
      'title' => 'Dreamlander',
      'class' => 'literatura asesoria',
      'img_href' => 'dl_450_t.jpg',
      'img_alt' => 'informe de lectura editorial',
      'modal_title' => 'Dreamlander',
      'modal_subtitle' => 'Informe de lectura editorial',
      'modal_text' => '<p>Como lectora editorial, realizo análisis de libros para determinar si a la editorial le conviene publicarlos, por razones literarias y comerciales. Editoriales como Penguin Random House necesitan la ayuda de un lector profesional para cribar los libros que llegan a sus oficinas todos los días. En el caso de <i>Dreamlander</i>, se trataba de la propuesta de un traductor, por lo que leí la obra en inglés, junto con unos fragmentos traducidos anticipados por el traductor. </p>
      ...
      'modal_imgs' => [
        [
          'src' => 'dl_3.jpg',
          'alt' => 'informe de lectura editorial ejemplo',
        ],[
          'src' => 'dl_2.jpg',
          'alt' => 'informe de lectura editorial ejemplo',
        ],[
      ...
      'modal_footer' => '<li>Fecha: Abril 2017</li>
      <li>Cliente: Penguin Random House</li>
      <li>Categoría: Informe de lectura editorial</li>',
    ],[
      'id' => 'portfolioModal10',
      'title' => 'Functionalism and Minimalism',
      'class' => 'academico correccion',
      'img_href' => 'grammaressay.jpg',
      'img_alt' => 'copyediting corrección de estilo editing',
      'modal_title' => 'Functionalism and Minimalism in Grammar',
      'modal_subtitle' => '<i>Copy-editing</i> – corrección de estilo y contenido',
      'modal_text' => '<p>Walther requería una corrección profunda que revisara a fondo también sus conclusiones. Por suerte, al haber cursado lingüística en el pasado tenía los conocimientos necesarios para entender y poder cuestionar sus argumentos.</p>
      ...
      'modal_imgs' => [
        [
          'src' => 'cena2.jpg',
          'alt' => 'asesoría literaria corrección de estilo',
        ],[
          'src' => 'cena1.jpg',
          'alt' => 'asesoría literaria corrección de estilo',
        ],[
      ...
      'modal_footer' => '<li>Fecha: Mayo 2017</li>
      <li>Cliente: Javier Cebrián</li>
      <li>Categoría: Asesoría literaria y corrección de estilo</li>',
    ],[
      'id' => 'portfolioModal12',
      'title' => 'The Body Massamagrell',
      'class' => 'copywriting web marketing',
      'img_href' => 'the_body_massamagrell.jpg',
      'img_alt' => 'copywriting marketing',
      'modal_title' => 'The Body Massamagrell',
      'modal_subtitle' => 'Marketing y redes sociales',
      'modal_text' => '<p>The Body Massamagrell no estaba aprovechando sus dos años de vida y todos los clientes fijos y muy entusiastas que había conseguido, así que lo primero que hicimos fue buscar sus testimonios para crear <b>autoridad y confianza</b>. </p>
      ...
      'modal_imgs' => [
        [
          'src' => 'the_body_1.jpg',
          'alt' => 'marketing gestión redes sociales',
        ],[
          'src' => 'the_body_2.jpg',
          'alt' => 'marketing gestión redes sociales',
        ],[
      ...
      'title' => 'Barquitos',
      'class' => 'correccion',
      'img_href' => 'barquitos.jpg',
      'img_alt' => 'copywriting marketing',
      'modal_title' => 'Barquitos',
      'modal_subtitle' => 'Corrección',
      ...
      'modal_imgs' => [
        [
          'src' => 'barquitos_1.jpg',
          'alt' => 'corrección ortotipográfica y de estilo',
        ],[
          'src' => 'barquitos_2.jpg',
          'alt' => 'corrección ortotipográfica y de estilo',
        ],[
      ...
      'modal_footer' => '<li>Fecha: Junio 2018</li>
      <li>Cliente: Javier Cebrián</li>
      <li>Categoría: Corrección</li>',
    ],[
      'id' => 'portfolioModal13',
      'title' => 'WriterMuse',
      'class' => 'correccion asesoria literatura web',
      'img_href' => 'writermuse.jpg',
      'img_alt' => 'asesoría literaria corrección para escritores writermuse',
      'modal_title' => 'WriterMuse',
      'modal_subtitle' => 'Asesoría y corrección para escritores',
      'modal_text' => '<p>Writermuse es mi <b>negocio online</b> para llevar la creatividad y el placer de la escritura a todo el mundo.</p>
      <p>Mi único propósito con WriterMuse es que <b>los escritores escriban y que disfruten con ello</b>. Más y mejor vienen con la práctica, pero lo principal es sentarse a trabajar. Hay mucha gente que vive la escritura como una vocación pero que no escribe o que no confía en lo que ha escrito; se resisten a escribir o a dejar partir una obra que consideran imperfecta e inadecuada. Pero la escritura se puede vivir de otra manera, de la manera creativa.</p>
      <h3 class="text-center">Con WriterMuse quiero darte la seguridad de que puedes escribir y publicar tu novela. <br>Quiero que no te quedes con tu historia sin contar.</h3><br>
      <p>Escribo una vez a la semana y preparo recursos para escritores para aprender a escribir más y para poder acceder a la inspiración siempre que lo necesiten. La creatividad se puede –¡y se debe!– ejercitar. No descuido tampoco el lado crítico. En WriterMuse te ayudo a planear tu novela desde cero y a detectar qué funciona y qué no, en tu propio libro y en otros. Ser un maestro de la narrativa también está a tu alcance si entiendes qué hace que tus libros preferidos funcionen.</p>
      ...
      'modal_imgs' => [
        [
          'src' => 'writermuse_1_b.jpg',
          'alt' => 'Asesoría y corrección para escritores writermuse',
        ],[
          'src' => 'writermuse_2.jpg',
          'alt' => 'Asesoría y corrección para escritores writermuse',
        ],[
          'src' => 'writermuse_3.jpg',
          'alt' => 'Asesoría y corrección para escritores writermuse',
        ],[
          'src' => 'writermuse_4.jpg',
          'alt' => 'Asesoría y corrección para escritores writermuse',
        ],[
          'src' => 'writermuse_5.jpg',
          'alt' => 'Asesoría y corrección para escritores writermuse',
        ],[
          'src' => 'writermuse_6.jpg',
          'alt' => 'Asesoría y corrección para escritores writermuse',
        ],
      ],
      'modal_footer' => '<li>Fecha: Septiembre 2016</li>
...
<section id="portfolio" class="bg-light">
  <div class="container">
    ...
    <div class="row grid">
      ...
      <!-- Aqui generamos los cuadrados -->
      <?php foreach ($portfolios as $p): ?>
        <div class="col-md-25 col-sm-4 portfolio-item grid-item <?= $p['class'] ?>">
          <a href="#<?= $p['id'] ?>" class="portfolio-link" data-toggle="modal">
            ...
            <img src="img/portfolio/<?= $p['img_href'] ?>" class="img-responsive" alt="<?= $p['img_alt'] ?>">
          </a>
        </div>
      <?php endforeach ?>
      ...
      <div class="modal-content">
        ...
        <div class="container">
          <div class="modal-body">
            <h2><?= $p['modal_title'] ?></h2>
            <p class="item-intro text-muted"><?= $p['modal_subtitle'] ?></p>
            <div class="row">
              <div class="col-sm-8 col-sm-offset-2 modal_text">
                <?= $p['modal_text'] ?>
              </div>
            </div>
            <div class="row">
